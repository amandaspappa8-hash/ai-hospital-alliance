...
export default function ReportsPage() {
    ...
    async function handleMintToBlockchain() {
        try {
            ...
            setMintResult(`Blockchain mint success | tx: ${result.txHash} | total tokens: ${result.totalTokens}`);
        }
        catch (err) {
            console.error(err);
    ...
    return (_jsxs("div", { style: { padding: 24, color: "white" }, children: [_jsx("h1", { style: { fontSize: 30, marginBottom: 8 }, children: "Reports" }), _jsx("p", { style: { opacity: 0.8, marginBottom: 20 }, children: "Official clinical and AI-generated reports" }), _jsxs("div", { style: {
                    ...
                    marginBottom: 20,
                            ...
                            cursor: "pointer",
                            fontWeight: 700,
                        }, children: "Print / Save PDF" }), _jsx("button", { onClick: handleMintToBlockchain, disabled: mintingBlockchain || loadingReport || !patient, style: {
                        ...
                        }, children: mintingBlockchain ? "Minting to Blockchain..." : "Mint Medical Report NFT" })] }), error && (_jsx("div", { style: { color: "#fecaca", marginBottom: 16 }, children: error })), mintResult && (_jsx("div", { style: {
                    marginBottom: 16,
                    padding: 12,
                    borderRadius: 10,
                    background: "#052e16",
                ...
                }, children: mintResult })), _jsxs("div", { id: "clinical-report", style: {
                    background: "white",
                    color: "#111827",
                    borderRadius: 18,
                    padding: 28,
