...
function StatCard({ title, value }) {
    return (_jsxs("div", { style: {
            ...
            padding: "22px",
            minHeight: "140px",
        }, children: [_jsx("div", { style: { opacity: 0.8, marginBottom: "18px" }, children: title }), _jsx("div", { style: { fontSize: "42px", fontWeight: 700 }, children: value }), _jsx("button", { onClick: () => Sentry.captureException(new Error("Dashboard test")), children: "Test Sentry" })] }));
}
